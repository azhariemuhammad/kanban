   ...
   <div class="login-btn">
      <a href="#" class="button" data-toggle="modal" data-target="#login-modal" style="color: #999;">Add Task</a>
        ...
        <form @submit.prevent="addNewTask">
          ...
          <input type="text" name="assignedTo" v-model="formNewTask.assignedTo" placeholder="Assigned To">
...
export default {
  ...
  methods: {
    addNewTask: function () {
      db.ref('/backlog').push(this.formNewTask)
      alert('Succes create a new Task')
      this.clearField()
    },
    clearField: function () {
      this.formNewTask = {}
